...
def home():
    ...
    if request.method == 'GET':
        if 'current_note_name' in session:
            ...
            if current_note == None:
                return render_template('editor.html', tag_notes_dict = tag_notes_dict, filename = '', file_contents = '', recommended_tags = session['recommended_tags'])
            else:
                return render_template('editor.html', tag_notes_dict = tag_notes_dict, filename = current_note.filename, file_contents = current_note.file_contents, recommended_tags = session['recommended_tags'])
        else:
            return render_template('editor.html', tag_notes_dict = tag_notes_dict, filename = '', file_contents = '', recommended_tags = session['recommended_tags'])
    ...
    if 'recommendedTags' in request.form:
        ...
        return render_template('editor.html', tag_notes_dict = tag_notes_dict, filename = current_note.filename, file_contents = current_note.file_contents, recommendedTags = [])
